...
# 'Pythonexe & PythonScript & "" & "--username" & "" & username & "" & "--password" & "" & password  "" & "--url" & "" & url  "" & "--secure" & "" & secure  "" & "--shoe-size" & "" & taile & "--driver-type" & "" & driver_type

###### Parametre elements
type_driver = "chrome"
headless = "store_true" 
user_username = "mohamedsaros@gmail.com"
user_password = "Momo2020"
shoe_url = "https://www.nike.com/fr/launch/t/womens-lahar-low-black"
shoe_size = 36
cvv_secure = 333
...
def run_boot(driver_type,headless):
    ...
    run(driver=driver,username=user_username, password=user_password, url=shoe_url, secure=cvv_secure,shoe_size=shoe_size,login_time=None,release_time=None,page_load_timeout=30,num_retries=1,dont_quit=True)
    
    
    

run_boot(type_driver,headless)